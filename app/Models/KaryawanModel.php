...
class KaryawanModel extends Model
{
    ...
    {
        return $this->select('karyawan.id_karyawan, karyawan.kode_kartu, karyawan.nama_karyawan, karyawan.tanggal_masuk, karyawan.jenis_kelamin, karyawan.shift, karyawan.status, bagian.nama_bagian')
