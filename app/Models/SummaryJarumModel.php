...
class SummaryJarumModel extends Model
{
    ...
    {
        return $this->select('sum_jarum.id_karyawan, sum_jarum.tgl_input, SUM(sum_jarum.used_needle) AS total_jarum, karyawan.kode_kartu, karyawan.nama_karyawan, karyawan.jenis_kelamin, karyawan.tgl_masuk, bagian.nama_bagian, sum_jarum.created_at, sum_jarum.updated_at, periode.start_date, periode.end_date, periode.nama_periode, periode.id_batch, bagian.area,  periode.jml_libur')
