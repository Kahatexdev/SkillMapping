<aside
    class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray shadow-lg"
    ...
    <div class="collapse navbar-collapse  h-auto w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <?php if ($role == 'Monitoring'): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $title == 'Report Batch' ? 'active' : '' ?>"
                        href="<?= base_url('Monitoring/reportBatch') ?>">
                        <!-- icon Penilaian -->
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
            ...
            <?php if ($role == 'Mandor'): ?>
                ...
                <!-- Absen -->
                <li class="nav-item">
                    <a class="nav-link <?= $title == 'Absen' ? 'active' : '' ?>" href="<?= base_url('mandor/dataAbsen') ?>">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg class="text-dark" width="16px" height="16px" viewBox="0 0 40 44" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
