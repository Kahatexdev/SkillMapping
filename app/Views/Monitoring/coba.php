                                ...
                                <?php if (!empty($jobrole)) : ?>
                                    <?php foreach ($jobrole as $jobrole) : ?>
                                        <tr>
                                            ...
                                            <!-- Menampilkan Data JOB berdasarkan id_jobrole -->
                                            <td>
                                                <?php if (isset($groupedData[$jobrole['id_jobrole']]['JOB'])): ?>
                                                    <ul>
                                                        <?php foreach ($groupedData[$jobrole['id_jobrole']]['JOB'] as $job): ?>
                                                            <li><?= $job; ?></li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                <?php else: ?>
                                            ...
                                            <!-- Menampilkan Data 6S berdasarkan id_jobrole -->
                                            <td>
                                                <?php if (isset($groupedData[$jobrole['id_jobrole']]['6S'])): ?>
                                                    <ul>
                                                        <?php foreach ($groupedData[$jobrole['id_jobrole']]['6S'] as $sixS): ?>
                                                            <li><?= $sixS; ?></li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                <?php else: ?>
                                                    <p>No 6S data available.</p>
                                                <?php endif; ?>
                                            </td>
