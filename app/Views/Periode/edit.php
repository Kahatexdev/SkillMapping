...
<div class="container-fluid py-4">
    ...
    <div class="row mt-4">
        <div class="col-xl-12 col-sm-12 mb-xl-0 mb-4 mt-2">
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url('monitoring/periodeUpdate/' . $periode['id_periode']) ?>" method="post">
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <select class="form-select" id="nama_periode" name="nama_periode" required>
                                        ...
                                        <option value="Pertengahan">Periode Pertengahan</option>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    ...
                                    <input type="date" class="form-control" id="start_date" name="start_date" value="<?= $periode['start_date'] ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group mb-2">
                                    <label for="end_date">Tanggal Selesai</label>
                                    <input type="date" class="form-control" id="end_date" name="end_date" value="<?= $periode['end_date'] ?>" required>
                                </div>
                            </div>
                        </div>
