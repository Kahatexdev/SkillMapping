                ...
                <div class="card-body w-100">
                    <div class="table-responsive">
                        <table class="table table-responsive w-100">
                            <thead>
                                <tr>
                                    <th class="sticky" colspan="5">SUMMARY ROSSO PERIODE AWAL (26-12-2024 S/D 30-12-2024) AREA (KK1A)</th>
                ...
                <div class="card-body w-100">
                    <div class="table-responsive">
                        <table class="table table-responsive w-100">
                            <thead>
                                <tr>
                                    <th class="sticky" colspan="5">SUMMARY ROSSO PERIODE TENGAH (26-12-2024 S/D 30-12-2024) AREA (KK1A)</th>
                                    <th colspan="21">OKTOBER 2024</th>
                                </tr>
                                <tr>
                                    <th class="sticky" rowspan="2">Kode Kartu</th>
                ...
                <div class="card-body w-100">
                    <div class="table-responsive">
                        <table class="table table-responsive w-100">
                            <thead>
                                <tr>
                                    <th class="sticky" colspan="5">SUMMARY ROSSO PERIODE AKHIR (26-12-2024 S/D 30-12-2024) AREA (KK1A)</th>
                                    <th colspan="21">OKTOBER 2024</th>
                                </tr>
                                <tr>
                                    <th class="sticky" rowspan="2">Kode Kartu</th>
